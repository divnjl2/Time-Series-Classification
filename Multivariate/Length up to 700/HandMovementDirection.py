### Dataset: HandMovementDirection, Dimensions: 10, Length: 400, Train Size: 160, Test Size: 74, Classes: 4, Type: EEG ###
...
# Load the dataset
X_train_raw, y_train = load_UCR_UEA_dataset("HandMovementDirection", split="train", return_X_y=True)
X_test_raw, y_test = load_UCR_UEA_dataset("HandMovementDirection", split="test", return_X_y=True)
